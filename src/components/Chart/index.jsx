...
import { BarElement, Chart as ChartJS, CategoryScale, LinearScale, Title, Tooltip } from 'chart.js'
    ...
    <article className='bg-white p-8 mt-8 rounded-2xl shadow'>
      ...
      >
        <h2 className='font-bold text-4xl'>
          <span className='text-base font-normal block opacity-75'>Total this month</span> $478.33
        </h2>
        <h3 className='flex flex-col items-end justify-end text-base font-bold'>
          +2.4% <span className='font-normal block opacity-75'>from last month</span>
        </h3>
      </article>
    </article>
  )
